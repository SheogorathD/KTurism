 ...
 get_header(); ?>
	<div class="container">
        ...
        <script>
            ...
            }).bindPopup("<img src='<?php oimage('11.jpg'); ?>' width='100%' height='auto'><p style='font-size: 20px;'>Соляні промисли («Рожеві озера») у селі Геройському (Скадовський район).</p><div style='display:flex; flex-direction: row; justify-content: space-between;'><a href='ozera' style='font-size:15px; color: #000; padding-top:17px;'>Детальніше ></a><a href='https://goo.gl/maps/fvf4PBRrfFWfBSrb7'><img src='<?php echo get_template_directory_uri(); ?>/media/img/icons/google-map.svg' width='30px' style='padding-right: 10px;' alt='google-maps'></a></div>", {maxHeight: 500, minWidth: 400});

            var cP = L.marker([47.23884818323438, 33.90536072037797], {
                icon: onlyMarker,
                title:"с. Новоолександрівка Бериславського району",
            }).bindPopup("<img src='<?php oimage('12.jpg'); ?>' width='100%' height='auto'><p style='font-size: 20px;'>Руїни палацу Фальц-Фейнів (с. Новоолександрівка Бериславського району)</p><div style='display:flex; flex-direction: row; justify-content: space-between;'><a href='ruins' style='font-size:15px; color: #000; padding-top:17px;'>Детальніше ></a><a href='https://goo.gl/maps/ixkzu7zm7UQ3tKda7'><img src='<?php echo get_template_directory_uri(); ?>/media/img/icons/google-map.svg' width='30px' style='padding-right: 10px;' alt='google-maps'></a></div>", {maxHeight: 500, minWidth: 400});
            ...
            icon: onlyMarker,
            title:"с. Веселе Бериславського району",
            }).bindPopup("<p style='font-size: 20px;'>Виноробне господарство Князя П. М. Трубецького</p><div style='display:flex; flex-direction: row; justify-content: space-between;'><a href='#' style='font-size:15px; color: #000; padding-top:17px;'>Детальніше ></a><a href='https://goo.gl/maps/uweGSMpSog2KTXDY9'><img src='<?php echo get_template_directory_uri(); ?>/media/img/icons/google-map.svg' width='30px' style='padding-right: 10px;' alt='google-maps'></a></div>", {maxHeight: 500, minWidth: 400});
            
            var gB = L.marker([46.7472716882117, 33.295550559056814], {
            icon: onlyMarker,
            title:"м. Нова Каховка",
            }).bindPopup("<p style='font-size: 20px;'>Дім марочних коньяків «Таврія»</p><div style='display:flex; flex-direction: row; justify-content: space-between;'><a href='#' style='font-size:15px; color: #000; padding-top:17px;'>Детальніше ></a><a href='https://goo.gl/maps/T8wbmBrFtcdhAF7aA'><img src='<?php echo get_template_directory_uri(); ?>/media/img/icons/google-map.svg' width='30px' style='padding-right: 10px;' alt='google-maps'></a></div>", {maxHeight: 500, minWidth: 400});

            var gC = L.marker([46.542647962514536, 32.56654631659656], {
            icon: onlyMarker,
            title:"м. Гола Пристань Скадовського району",
            }).bindPopup("<p style='font-size: 20px;'>Сімейна виноробня «Клара Марсала»</p><div style='display:flex; flex-direction: row; justify-content: space-between;'><a href='#' style='font-size:15px; color: #000; padding-top:17px;'>Детальніше ></a><a href='https://goo.gl/maps/Q89xkxexTnA8JTVt5'><img src='<?php echo get_template_directory_uri(); ?>/media/img/icons/google-map.svg' width='30px' style='padding-right: 10px;' alt='google-maps'></a></div>", {maxHeight: 500, minWidth: 400});

            var gD = L.marker([46.71944725123051, 32.580721463733525], {
            icon: onlyMarker,
            title:"с. Степанівка Херсонської міської ради",
            }).bindPopup("<p style='font-size: 20px;'>Сімейна виноробня «Château Kurin» </p><div style='display:flex; flex-direction: row; justify-content: space-between;'><a href='#' style='font-size:15px; color: #000; padding-top:17px;'>Детальніше ></a><a href='https://goo.gl/maps/SXSsg2shsiFY9fFV9'><img src='<?php echo get_template_directory_uri(); ?>/media/img/icons/google-map.svg' width='30px' style='padding-right: 10px;' alt='google-maps'></a></div>", {maxHeight: 500, minWidth: 400});

            var gE = L.marker([46.62721369983363, 32.74091260881092], {
            icon: onlyMarker,
            title:"м. Олешки, Херсонського району",
            }).bindPopup("<p style='font-size: 20px;'>Ресторан авторської української кухні «Пан Отаман»</p><div style='display:flex; flex-direction: row; justify-content: space-between;'><a href='#' style='font-size:15px; color: #000; padding-top:17px;'>Детальніше ></a><a href='https://g.page/pan-ataman-kherson?share'><img src='<?php echo get_template_directory_uri(); ?>/media/img/icons/google-map.svg' width='30px' style='padding-right: 10px;' alt='google-maps'></a></div>", {maxHeight: 500, minWidth: 400});

            var gF = L.marker([46.576282529527866, 32.15849398187228], {
            icon: onlyMarker,
            title:"с. Станіслав Херсонського району",
            }).bindPopup("<p style='font-size: 20px;'>Екоферма «Лиманська коза»</p><div style='display:flex; flex-direction: row; justify-content: space-between;'><a href='#' style='font-size:15px; color: #000; padding-top:17px;'>Детальніше ></a><a href='https://goo.gl/maps/wVyA1MirqYgXSMBp7'><img src='<?php echo get_template_directory_uri(); ?>/media/img/icons/google-map.svg' width='30px' style='padding-right: 10px;' alt='google-maps'></a></div>", {maxHeight: 500, minWidth: 400});

            // var gG = L.marker([46.62721369983363, 32.74091260881092], {
            // icon: onlyMarker,                                                     Нет координат
            // title:"с. Музиківка Херсонського району",
            // }).bindPopup("<p style='font-size: 20px;'>Екоферма «Коза Амальтея»</p><div style='display:flex; flex-direction: row; justify-content: space-between;'><a href='#' style='font-size:15px; color: #000; padding-top:17px;'>Детальніше ></a><a href='https://g.page/pan-ataman-kherson?share'><img src='<?php echo get_template_directory_uri(); ?>/media/img/icons/google-map.svg' width='30px' style='padding-right: 10px;' alt='google-maps'></a></div>", {maxHeight: 500, minWidth: 400});

            var gH = L.marker([46.551650587827154, 33.8219714226995], {
            icon: onlyMarker,
            title:"с. Тавричанка Каховського району",
            }).bindPopup("<p style='font-size: 20px;'>Державне підприємство «Дослідне господарство «Асканійське»</p><div style='display:flex; flex-direction: row; justify-content: space-between;'><a href='#' style='font-size:15px; color: #000; padding-top:17px;'>Детальніше ></a><a href='https://goo.gl/maps/Qjgfmecka8LLWPUc9'><img src='<?php echo get_template_directory_uri(); ?>/media/img/icons/google-map.svg' width='30px' style='padding-right: 10px;' alt='google-maps'></a></div>", {maxHeight: 500, minWidth: 400});
            ...
            }).bindPopup("<p style='font-size: 20px;'>Національний природний парк «Олешківські піски»</p><div style='display:flex; flex-direction: row; justify-content: space-between;'><a href='#' style='font-size:15px; color: #000; padding-top:17px;'>Детальніше ></a><a href='https://goo.gl/maps/8J97h8X3oevaW1Xd7'><img src='<?php echo get_template_directory_uri(); ?>/media/img/icons/google-map.svg' width='30px' style='padding-right: 10px;' alt='google-maps'></a></div>", {maxHeight: 500, minWidth: 400});

            var eB = L.marker([47.069163891159185, 33.628333938236125], {
            icon: onlyMarker,
            title:"",
            }).bindPopup("<p style='font-size: 20px;'>Національний природний парк «Кам’янська Січ»</p><div style='display:flex; flex-direction: row; justify-content: space-between;'><a href='#' style='font-size:15px; color: #000; padding-top:17px;'>Детальніше ></a><a href='https://goo.gl/maps/JoAZQ19MhRLxiM759'><img src='<?php echo get_template_directory_uri(); ?>/media/img/icons/google-map.svg' width='30px' style='padding-right: 10px;' alt='google-maps'></a></div>", {maxHeight: 500, minWidth: 400});

            var eC = L.marker([46.66621962850968, 32.65733922103027], {
            icon: onlyMarker,
            title:"",
            }).bindPopup("<p style='font-size: 20px;'>Національний природний парк «Нижньодніпровський»</p><div style='display:flex; flex-direction: row; justify-content: space-between;'><a href='#' style='font-size:15px; color: #000; padding-top:17px;'>Детальніше ></a><a href='https://goo.gl/maps/tEZJRwmdxVcfdjmB8'><img src='<?php echo get_template_directory_uri(); ?>/media/img/icons/google-map.svg' width='30px' style='padding-right: 10px;' alt='google-maps'></a></div>", {maxHeight: 500, minWidth: 400});

            var eD = L.marker([46.5860135786528, 32.12511509301834], {
            icon: onlyMarker,
            title:"(«Станіславські скелі»",
            }).bindPopup("<p style='font-size: 20px;'>Станіславський ландшафтний заказник загальнодержавного значення</p><div style='display:flex; flex-direction: row; justify-content: space-between;'><a href='#' style='font-size:15px; color: #000; padding-top:17px;'>Детальніше ></a><a href='https://goo.gl/maps/cyWpFvui5qEYyyBg8'><img src='<?php echo get_template_directory_uri(); ?>/media/img/icons/google-map.svg' width='30px' style='padding-right: 10px;' alt='google-maps'></a></div>", {maxHeight: 500, minWidth: 400});
            ...
            }).bindPopup("<p style='font-size: 20px;'>База зеленого туризму «Чумацька криниця»</p><div style='display:flex; flex-direction: row; justify-content: space-between;'><a href='#' style='font-size:15px; color: #000; padding-top:17px;'>Детальніше ></a><a href='https://goo.gl/maps/KqAu7Hd44jiiue5X9'><img src='<?php echo get_template_directory_uri(); ?>/media/img/icons/google-map.svg' width='30px' style='padding-right: 10px;' alt='google-maps'></a></div>", {maxHeight: 500, minWidth: 400});

            var eG = L.marker([46.539481931974315, 32.553932996153655], {
            icon: onlyMarker,
            title:"м. Гола Пристань Скадовського району",
            }).bindPopup("<p style='font-size: 20px;'>База зеленого туризму «Чайка»</p><div style='display:flex; flex-direction: row; justify-content: space-between;'><a href='#' style='font-size:15px; color: #000; padding-top:17px;'>Детальніше ></a><a href='https://goo.gl/maps/P6a6hoG8kZ3MYHDo7'><img src='<?php echo get_template_directory_uri(); ?>/media/img/icons/google-map.svg' width='30px' style='padding-right: 10px;' alt='google-maps'></a></div>", {maxHeight: 500, minWidth: 400});

            var eH = L.marker([46.59004812383713, 32.748431456522596], {
            icon: onlyMarker,
            title:"с. Нечаєво Херсонського району",
            }).bindPopup("<p style='font-size: 20px;'>Зелена садиба «Казка Олешшя»</p><div style='display:flex; flex-direction: row; justify-content: space-between;'><a href='#' style='font-size:15px; color: #000; padding-top:17px;'>Детальніше ></a><a href='https://goo.gl/maps/cE1ESdysfmSuEj8GA'><img src='<?php echo get_template_directory_uri(); ?>/media/img/icons/google-map.svg' width='30px' style='padding-right: 10px;' alt='google-maps'></a></div>", {maxHeight: 500, minWidth: 400});
            ...
            icon: onlyMarker,
            title:"м. Олешки Херсонського району",
            }).bindPopup("<p style='font-size: 20px;'>Кінний клуб «Буцефал»</p><div style='display:flex; flex-direction: row; justify-content: space-between;'><a href='#' style='font-size:15px; color: #000; padding-top:17px;'>Детальніше ></a><a href='https://goo.gl/maps/8h4fDnvdoSttYi8i8'><img src='<?php echo get_template_directory_uri(); ?>/media/img/icons/google-map.svg' width='30px' style='padding-right: 10px;' alt='google-maps'></a></div>", {maxHeight: 500, minWidth: 400});

            var aB = L.marker([46.59831528588017, 32.79357796573364], {
            icon: onlyMarker,
            title:"с. Саги Херсонського району",
            }).bindPopup("<p style='font-size: 20px;'>Кінний клуб «Grand-Prix»</p><div style='display:flex; flex-direction: row; justify-content: space-between;'><a href='#' style='font-size:15px; color: #000; padding-top:17px;'>Детальніше ></a><a href='https://goo.gl/maps/r7Tq8tnWxjDHqesA8'><img src='<?php echo get_template_directory_uri(); ?>/media/img/icons/google-map.svg' width='30px' style='padding-right: 10px;' alt='google-maps'></a></div>", {maxHeight: 500, minWidth: 400});

            var aC = L.marker([46.75550008039247, 33.33602694102427], {
            icon: onlyMarker,
            title:"м. Нова Каховка",
            }).bindPopup("<p style='font-size: 20px;'>Яхт-клуб «Maxmarine» </p><div style='display:flex; flex-direction: row; justify-content: space-between;'><a href='#' style='font-size:15px; color: #000; padding-top:17px;'>Детальніше ></a><a href='https://goo.gl/maps/v9tKZtaeD6SdLRcD6'><img src='<?php echo get_template_directory_uri(); ?>/media/img/icons/google-map.svg' width='30px' style='padding-right: 10px;' alt='google-maps'></a></div>", {maxHeight: 500, minWidth: 400});

            var aD = L.marker([46.63243727081649, 32.61546493146783], {
            icon: onlyMarker,
            title:"м. Херсон, 3-й затон",
            }).bindPopup("<p style='font-size: 20px;'>Агенція екотуризму «ForTouristTravel»</p><div style='display:flex; flex-direction: row; justify-content: space-between;'><a href='#' style='font-size:15px; color: #000; padding-top:17px;'>Детальніше ></a><a href='https://goo.gl/maps/m72wqFNSjjqssbaSA'><img src='<?php echo get_template_directory_uri(); ?>/media/img/icons/google-map.svg' width='30px' style='padding-right: 10px;' alt='google-maps'></a></div>", {maxHeight: 500, minWidth: 400});

            var aE = L.marker([48.579482380697094, 35.236921741924235], {
            icon: onlyMarker,
            title:"м. Херсон, 3-й затон",
            }).bindPopup("<p style='font-size: 20px;'>Клуб активного відпочинку River Club</p><div style='display:flex; flex-direction: row; justify-content: space-between;'><a href='#' style='font-size:15px; color: #000; padding-top:17px;'>Детальніше ></a><a href='https://goo.gl/maps/8PPsEwwRNz5xQ5SE6'><img src='<?php echo get_template_directory_uri(); ?>/media/img/icons/google-map.svg' width='30px' style='padding-right: 10px;' alt='google-maps'></a></div>", {maxHeight: 500, minWidth: 400});

            var aF = L.marker([46.57286046203756, 32.13292016239571], {
            icon: onlyMarker,
            title:"с. Станіслав Херсонського району",
            }).bindPopup("<p style='font-size: 20px;'>Flykherson: Outdoor Activity Organiser</p><div style='display:flex; flex-direction: row; justify-content: space-between;'><a href='#' style='font-size:15px; color: #000; padding-top:17px;'>Детальніше ></a><a href='https://goo.gl/maps/MUfm913DHfTYvdyJA'><img src='<?php echo get_template_directory_uri(); ?>/media/img/icons/google-map.svg' width='30px' style='padding-right: 10px;' alt='google-maps'></a></div>", {maxHeight: 500, minWidth: 400});
